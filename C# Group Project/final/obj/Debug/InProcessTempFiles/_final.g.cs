    ...
    internal class _XamlStaticHelper {
        ...
        private static System.Collections.Generic.IList<System.Reflection.Assembly> LoadAssemblies() {
            ...
            assemblyList.Add(Load("EntityFramework.SqlServer, Version=6.0.0.0, Culture=neutral, PublicKeyToken=b77a5" +
                        "c561934e089"));
            assemblyList.Add(Load("Microsoft.AI.Agent.Intercept, Version=2.4.0.0, Culture=neutral, PublicKeyToken=31" +
                        "bf3856ad364e35"));
            assemblyList.Add(Load("Microsoft.AI.DependencyCollector, Version=2.4.1.0, Culture=neutral, PublicKeyToke" +
                        "n=31bf3856ad364e35"));
            assemblyList.Add(Load("Microsoft.AI.PerfCounterCollector, Version=2.4.1.0, Culture=neutral, PublicKeyTok" +
                        "en=31bf3856ad364e35"));
            assemblyList.Add(Load("Microsoft.AI.ServerTelemetryChannel, Version=2.4.0.0, Culture=neutral, PublicKeyT" +
                        "oken=31bf3856ad364e35"));
            assemblyList.Add(Load("Microsoft.AI.Web, Version=2.4.1.0, Culture=neutral, PublicKeyToken=31bf3856ad364e" +
                        "35"));
            assemblyList.Add(Load("Microsoft.AI.WindowsServer, Version=2.4.1.0, Culture=neutral, PublicKeyToken=31bf" +
                        "3856ad364e35"));
            assemblyList.Add(Load("Microsoft.ApplicationInsights, Version=2.4.0.0, Culture=neutral, PublicKeyToken=3" +
                        "1bf3856ad364e35"));
            assemblyList.Add(Load("Microsoft.AspNet.TelemetryCorrelation, Version=1.0.0.0, Culture=neutral, PublicKe" +
                        "yToken=31bf3856ad364e35"));
            assemblyList.Add(Load("Microsoft.CodeDom.Providers.DotNetCompilerPlatform, Version=1.0.8.0, Culture=neut" +
